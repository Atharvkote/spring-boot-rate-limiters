...
class RateLimitFilterTest {
    ...
    @Mock
    private RateLimiterResolver limiterResolver;
    @Mock
    ...
    void setUp() {
        ...
        filter = new RateLimitFilter(props, clientResolver, limiterResolver, new ObjectMapper(),
    ...
    @Test
    @DisplayName("Allowed → chain continues + headers set")
    ...
    @Test
    @DisplayName("Rejected → 429 + Retry-After")
    ...
    @Test
    @DisplayName("Disabled → passes through")
    ...
    @Test
    @DisplayName("Fail-OPEN → allows on error")
    ...
    @Test
    @DisplayName("Fail-CLOSED → rejects on error")
